...
public class RomFactory {
	...
	private static Class[] supportedroms = { RomP13.class, RomP28.class,
			RomP30.class, RomP04.class };

	/**
	 * @return all loaded roms
	 */
	public static IRom[] getLoadedRoms() {
		return loadedroms.toArray(new IRom[] {});
	}
	...
	public static IRom loadRom(String filename) throws InvalidRomException {
		for (int i = 0; i < supportedroms.length; i++) {
			try {
				IRom rom = (IRom) supportedroms[i].getConstructor(
